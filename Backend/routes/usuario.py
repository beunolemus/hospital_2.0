...
@usuario.get('/usuarios',tags=["Usuarios"])
def get_usuarios():
    return usuarios

@usuario.post('/usuarios', tags=["Usuarios"])
def save_usuario(datos_usuario: model_usuarios):
    usuarios.append(datos_usuario)
    return "Usuario guardado correctamente"

@usuario.get('/usuarios/{usuario_id}',tags=["Usuarios"])
...
@usuario.put('/usuarios/{usuario_id}',tags=["Usuarios"])
...
@usuario.delete('/usuarios/{usuario_id}',tags=["Usuarios"])
