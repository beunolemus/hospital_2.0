...
@espacio_router.get("/espacios/", response_model=List[schemas.espacios.Espacio], tags=["Espacios"],dependencies=[Depends(Portador())])
...
@espacio_router.get("/espacios/{id}", response_model=schemas.espacios.Espacio, tags=["Espacios"],dependencies=[Depends(Portador())])
...
@espacio_router.post("/espacios/", response_model=schemas.espacios.Espacio, tags=["Espacios"],dependencies=[Depends(Portador())])
...
@espacio_router.put("/espacios/{id}", response_model=schemas.espacios.Espacio, tags=["Espacios"],dependencies=[Depends(Portador())])
...
@espacio_router.delete("/espacios/{id}", response_model=schemas.espacios.Espacio, tags=["Espacios"],dependencies=[Depends(Portador())])
