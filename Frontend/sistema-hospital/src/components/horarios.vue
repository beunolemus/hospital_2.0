    ...
    <section class="bg-gray-100 min-h-screen flex justify-center items-center">
      <div class="bg-[#D2E8E3] rounded-2xl p-10 flex flex-col items-center max-w-2xl w-full">
        <div class="w-full px-8">
          <h2 class="font-bold text-3xl text-[#0F6466] mb-4">Crear Nuevo Horario</h2>
          <p class="text-sm mb-8 text-[#002D74]">Agrega un nuevo horario para el empleado</p>
  
          <form @submit.prevent="createHorario" class="flex flex-col gap-4">
            ...
            <div class="w-full">
              <button class="bg-[#0593A2] text-white py-2 rounded-xl w-full hover:scale-105 duration-300 hover:bg-[#002c7424] font-medium" type="submit">Crear Horario</button>
            </div>
            <div class="w-full">
          ...
          <!-- Nuevo Botón para ir a la lista de horarios -->
  ...
  export default {
    ...
    methods: {
      createHorario() {
        ...
        console.log("Horario creado:", this.horario);
